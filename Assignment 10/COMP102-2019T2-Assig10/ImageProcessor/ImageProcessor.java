...
/* Code for COMP102 - 2019T2, Assignment 10
 * Name:
 * Username: 
 * ID: 
 */
...
public class ImageProcessor{
    ...
    private int[][] image = new int[][]{{80,80,80},{80, 200, 80},{80,80,80}}; //displays the image even if the code hasn't finished running it
    ...
    public void darkenImage(){
        ...
        for(int row = 0; row < this.image.length; row++){
            for(int col = 0; col < this.image[0].length; col++){  //this.image[row].length or this.length[0].length
                this.image[row][col] = this.image[row][col] - 20;   //making the image darker by minus 20 from row and col
                if(this.image[row][col] <= 0){                      //making it sure that it will not go below 0
                    this.image[row][col] = 0;                       //setting row and col to 0
                }
            }
        }
        this.redisplayImage();
    ...
    public void flipImageHorizontally(){
        /*# YOUR CODE HERE */
        //pretty much the opposite of Vertical
        for(int row=0;row<this.image.length;row++){
    ...
    public void rotateImage90(){
        /*# YOUR CODE HERE */
        //look at ChessPieces in week 11 notes
    ...
    public void expandImage(){
        /*# YOUR CODE HERE */
        int [][] temp = new int [image.length][image[0].length]; //new Array
        for(int row=0;row<this.image.length;row++){
            for(int col=0;col<this.image[0].length;col++){
    ...
    public void setupGUI(){
        ...
        UI.addButton("Clear",      UI::clearPanes); //Created a button to clear the pane
    ...
    public static void main(String[] arguments){
        ...
        obj.setupGUI();   // compute table of grey colours for converting images to greyscale.
